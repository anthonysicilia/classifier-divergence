...
# Dependencies
This package was built and tested on Python 3.7.6. While the requirements.txt has some newer package version numbers, the code has also been tested with the following versions:
